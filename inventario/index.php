...
<body>
<a style=  "margin-left: 62px" class="navbar-brand" href="<?= HOME; ?>"> <img src="<?= IMG; ?>uleam.png" style="max-width: 170px;"></a>
						...
						<div class="card-body">
							...
							<form method="POST" action="<?= ACTI.$action; ?>">
								...
								<div class="row">
									...
									<div class="col-sm-12">
									<a href="<?= URL; ?>registro.php/" class="btn btn-warning btn-block">Registro</a>
                  </div>
									<hr>
								</div>
							</form>
