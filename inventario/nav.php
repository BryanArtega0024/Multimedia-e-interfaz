	<header>
		<nav class="navbar navbar-expand-lg navbar-light " style="background-color: #C2D1F0
			...
			<div class="collapse navbar-collapse" id="navbarColor02" style=  "margin-left: 90px">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item <?php if($cod_pg==1){ echo 'active'; } ?>">
						<a class="nav-link h5.5"   href="<?= HOME; ?>"><b>Inicio</b> <span class="sr-only">(current)</span></a>
					</li>
					<?php if ($rid==1 || $rid==2) { ?>
					...
					<li class="nav-item <?php if($cod_pg==5){ echo 'active'; } ?>">
