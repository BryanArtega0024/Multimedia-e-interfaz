...
<body>
    ...
    <div id="eliminar" class="modal fade bd-example-modal-lg" tabindex="-1" tipoe="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="background-color: #2980B9 ;color: #fff;">
                <form method="POST" enctype="multipart/form-data" action="<?= ACTI.$action; ?>">
                    ...
                    <div class="modal-footer">
                        <button type="button" style = "background-color: white;color: #2980B9;" class="btn btn-warning" data-dismiss="modal">Cancelar</button>
                        <button type="submit" style = "background-color: white;color: #2980B9;" name="drop" class="btn btn-primary">Eliminar</button>
                    </div>
                </form>
            </div>
        </div>
